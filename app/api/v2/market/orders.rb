  ...
  module V2
    module Market
      class Orders < Grape::API
        ...
        params do
          optional :market,
                   values: { value: ->(v) { Array.wrap(v).all? { |value| value.in? ::Market.active.ids} }, message: 'market.market.doesnt_exist' },
          ...
          optional :state,
                   values: { value: ->(v) { Array.wrap(v).all? { |value| value.in? Order.state.values } }, message: 'market.order.invalid_state' },
