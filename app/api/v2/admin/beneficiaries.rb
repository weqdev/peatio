      ...
      class Beneficiaries < Grape::API
        ...
        namespace :beneficiaries do
          ...
          params do
            ...
            optional :currency,
                     values: { value: ->(v) { Array.wrap(v).all? { |value| value.in? ::Currency.ids } }, message: 'account.currency.doesnt_exist' },
                     desc: 'Beneficiary currency code'
            optional :state,
                     type: Array[Integer],
                     values: { value: ->(v) { Array.wrap(v).all? { |value| value.in? ::Beneficiary::STATES_MAPPING.values } }, message: 'account.beneficiary.invalid_state' },
